...
class PickUpHabits{
  final data = [
    Data(habit: 'brush', tag: 'wakeup', repeat: Repeating.daily, dates: []),
    Data(habit: 'drinkwater', tag: 'wakeup', repeat: Repeating.daily, dates: []),
    Data(habit: 'wakeearly', tag: 'wakeup', repeat: Repeating.daily, dates: []),
    Data(habit: 'excersize', tag: 'morning', repeat: Repeating.daily, dates: []),
    Data(habit: 'read', tag: 'morning', repeat: Repeating.daily, dates: []),
    Data(habit: 'lesscaffeine', tag: 'morning', repeat: Repeating.daily, dates: []),
    Data(habit: 'eatfruits', tag: 'noon', repeat: Repeating.daily, dates: []),
    Data(habit: 'drinkwater', tag: 'noon', repeat: Repeating.daily, dates: []),
    Data(habit: 'lesscaffeine', tag: 'noon', repeat: Repeating.daily, dates: []),
    Data(habit: 'stretch', tag: 'evening', repeat: Repeating.daily, dates: []),
    Data(habit: 'read', tag: 'evening', repeat: Repeating.daily, dates: []),
    Data(habit: 'takeashower', tag: 'evening', repeat: Repeating.daily, dates: []),
    Data(habit: 'drinkwater', tag: 'beforesleep', repeat: Repeating.daily, dates: []),
    Data(habit: 'fallasleepearly', tag: 'beforesleep', repeat: Repeating.daily, dates: []),
  ];
